...
- 루머에 따르면 Zeta 모델의 체급은 30B 정도로 추정되고 있습니다.
...
- 이 벤치마크 결과는 제타의 본래 용도인 롤플레잉에 대한 성능을 평가하기보다는, 범용 지식 테스트에서의 한계를 보여주는 지표로 활용될 수 있습니다.
- 범용으로 개발된 Qwen이나 Gemma 등 타 LLM과는 달리, Zeta (Spotwrite)는 롤플레잉에 특화된 모델입니다. 훈련 시 수학적 성능보다는 롤플레잉과 감성 대화 능력에 더 초점을 맞췄을 가능성이 높습니다.
